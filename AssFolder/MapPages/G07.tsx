...
const G07 = () => {
  const [imageSource, setImageSource] = useState(require('./MapImg/G07.png'));
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <TouchableOpacity style={styles.button}
          onPress={() => { setImageSource(require('./MapImg/G07.png')); }}>
...
const styles = StyleSheet.create({
  ...
  button: {
    backgroundColor: '#c85757',  // Updated to match G03 styling
    padding: 10,                // Updated to match G03 styling
    marginBottom: 10,
    borderRadius: 10,
    width: '100%',
    alignItems: 'center',
