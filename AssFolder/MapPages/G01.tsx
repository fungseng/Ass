...
const G01 = () => {
  const [imageSource, setImageSource] = useState(require('./MapImg/G01.png'));
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <TouchableOpacity style={styles.button}
          onPress={() => { setImageSource(require('./MapImg/G01.png')); }}>
...
const styles = StyleSheet.create({
  ...
  scrollViewContent: {
    width: '200%', // Make the content width twice the screen width
    paddingLeft: 70, // Add padding to the left side
    // Alternatively, you can use marginLeft if preferred:
    // marginLeft: 50,
  },
  image: {
    width: '100%',
