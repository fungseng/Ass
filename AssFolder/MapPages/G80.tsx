...
const G80 = () => {
  const [imageSource, setImageSource] = useState(require('./MapImg/G80.png'));
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/G80.png'));
          }}
        >
        ...
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/L1.png'));
          }}
        >
        ...
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/L2.png'));
          }}
        >
        ...
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/L3.png'));
          }}
        >
