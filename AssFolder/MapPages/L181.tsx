...
const L181 = () => {
  const [imageSource, setImageSource] = useState(require('./MapImg/L181.png'));
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/G.png'));
          }}
        >
        ...
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/L181.png'));
          }}
        >
        ...
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/F2.png'));
          }}
        >
        ...
        <TouchableOpacity 
          style={styles.button}
          onPress={() => {
            setImageSource(require('./MapImg/F3.png'));
          }}
        >
