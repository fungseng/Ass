...
const RussellSalon = () => {
  ...
  const storeData = stores.beauty.find(store => store.id === 1);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Beauty and service</Text>
        ...
        <TouchableOpacity
         ...
         onPress={() => navigation.navigate(L152)} // Update with correct route name
        >
