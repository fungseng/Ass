...
const Aeon2 = () => {
  ...
  const storeData = stores.department.find(store => store.id === 2);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Department Store</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(L181)} // Update with correct route name
        >
