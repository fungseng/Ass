...
import G22 from '../MapPages/G22'; // Import the BreadStoryMap component

const BreadStory = () => {
  const navigation = useNavigation();
  const storeData = stores.bakery.find(store => store.id === 1);
...
/>
      <View style={styles.storeInfo}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(G22)} // Update with correct route name
        >
