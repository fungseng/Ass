...
const GINTELL = () => {
  ...
  const storeData = stores.health.find(store => store.id === 1);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Health and Wellness</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(G14)} // Update with correct route name
        >
