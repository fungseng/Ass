...
const MyNews = () => {
  ...
  const storeData = stores.convienience.find(store => store.id === 1);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Convienience and Services</Text>
        ...
        <TouchableOpacity
         ...
         onPress={() => navigation.navigate(G21)} // Update with correct route name
        >
