...
const Balloon = () => {
  ...
  const storeData = stores.books.find(store => store.id === 3);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Books,Gifts and Toys</Text>
        ...
        <TouchableOpacity
         ...
         onPress={() => navigation.navigate(L175)} // Update with correct route name
        >
