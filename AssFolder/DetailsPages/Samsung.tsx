...
const Samsung = () => {
  ...
  const storeData = stores.digital.find(store => store.id === 2);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Digital and Home Appliances</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(L166)} // Update with correct route name
        >
