...
const MRDIY = () => {
  ...
  const storeData = stores.lifestyle.find(store => store.id === 2);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Lifestyle and Home Living</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(L165)} // Update with correct route name
        >
