...
const BoxHunt = () => {
  ...
  const storeData = stores.enrichment.find(store => store.id === 1);
...
/>
      <View style={styles.storeInfo}>
        <View style={styles.storeDetails}>
          <Text style={styles.category}>Enrichment and Hobbies</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(L170)} // Update with correct route name
        >
