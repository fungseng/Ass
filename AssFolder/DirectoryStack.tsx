...
import BreadStory from "./DetailsPages/BreadStory"; // Update with your actual path
import HoganBakery from "./DetailsPages/HoganBakery"; // Update with your actual path
